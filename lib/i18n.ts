...
export const dictionaries = {
  ar: {
    ...
    heroText: "أدخل رقم مترشحك وشاهد نتيجتك فوراً.",
    ...
    congratulations: "ألف ألف مبروك 🎉",
    sessionnaireMessage: "لديك فرصة في الدورة التكميلية. بالتوفيق والعمل الجاد يقود إلى النجاح!",
    notAdmittedMessage: "لا تفقد الأمل، فالنجاح طريق طويل وهذه مجرد محطة فيه. استمر وثابر.",
    annuleNote: "تم إلغاء هذا الامتحان لهذا المترشح.",
  ...
  fr: {
    ...
    heroText: "Entrez votre numéro de candidat et découvrez votre résultat instantanément.",
    ...
    sessionnaireMessage: "Vous avez une chance à la session complémentaire. Bon courage, la persévérance mène à la réussite !",
    notAdmittedMessage: "Ne perdez pas espoir : la réussite est un chemin fait de plusieurs étapes. Continuez et persévérez.",
    annuleNote: "Cet examen a été annulé pour ce candidat.",
