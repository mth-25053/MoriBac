...
export const dictionaries = {
  ar: {
    ...
    recentSearches: "آخر عمليات البحث", clearRecentSearches: "مسح السجل",
    ...
    resultPassSubtitle: "نتمنى لك مزيدًا من النجاح والتوفيق في مسيرتك الدراسية.",
    resultFailMessage: "نتمنى لك التوفيق والنجاح في المحاولة القادمة.",
    ...
    subjectGradesTitleComplementary: "نتائج المواد — الدورة التكميلية",
    ...
    subjectColumnFirstSession: "الدورة الأولى", subjectColumnSecondSession: "الدورة الثانية", subjectColumnRetained: "النتيجة المعتبرة",
    exemptLabel: "معفى",
  ...
  fr: {
    ...
    recentSearches: "Recherches récentes", clearRecentSearches: "Effacer",
    ...
    resultPassTitle: "🎉 Toutes nos félicitations !",
    resultPassSubtitle: "Nous vous souhaitons encore plus de réussite et de succès dans votre parcours scolaire.",
    resultFailMessage: "Nous vous souhaitons réussite et succès pour la prochaine tentative.",
    ...
    subjectGradesTitleComplementary: "Résultats par matière — Session complémentaire",
    ...
    subjectColumnFirstSession: "Session 1", subjectColumnSecondSession: "Session 2", subjectColumnRetained: "Note retenue",
